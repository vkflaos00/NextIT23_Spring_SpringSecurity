...
<script>
	$(function() {
		//alert("home.jsp");
		$("#page_footer")
				.load("${pageContext.request.contextPath}/home/footer");
	});

	window.onload = function() {
		let img_files = [ "${pageContext.request.contextPath}/images/img1.jpg",
	...
	<div id="wrap">
		<div id="img_div" class="intro_bg">
			<div class="header">
				...
				<ul class="nav">
					...
					<li><a
						href="${pageContext.request.contextPath }/free/freeList">FREEBOARD</a></li>
					<!--로그아웃  -->
					<li><a href="#">${memberVO.memId}</a>
						<ul>
							<li><a
								href="${pageContext.request.contextPath }/member/memberView?memId=${memberVO.memId}">info</a></li>
							<li><a href="#" onclick="fn_logout()">logout</a></li>

						<%-- 	<c:forEach items="${memberVO.userRoleList}" var="role">
								<c:if test="${role.userRole eq 'AD' }">
									<li><a
										href="${pageContext.request.contextPath}/member/memberList">members</a></li>
								</c:if>
							</c:forEach> --%>
		...
		<div class="main_text0">
			...
			<ul class="icons">
				<li>
					<div class="icon_img">
						<img src="${pageContext.request.contextPath}/images/icon0.svg"
							alt="이미지가 없습니다.">
					</div>
				...
				<li>
					<div class="icon_img">
						<img src="${pageContext.request.contextPath}/images/icon1.svg"
							alt="이미지가 없습니다.">
					</div>
					<div class="contents1_bold">
						<p>ABC</p>
				...
				<li>
					<div class="icon_img">
						<img src="${pageContext.request.contextPath}/images/icon2.svg"
							alt="이미지가 없습니다.">
					</div>
					<div class="contents1_bold">
						<p>ABC</p>
		...
		<div class="main_text1">
			...
			<div class="service">
				<div>
					<img src="${pageContext.request.contextPath}/images/img101.png"
						alt="이지미가 존재하지 않습니다.">
				</div>
				<div class="contents3">
					<h2>service content2</h2>
					<p>안녕하세요 NextIT 입니다. 만나서 반갑습니다. 안녕하세요 NextIT 입니다. 만나서 반갑습니다.
						안녕하세요 NextIT 입니다. 만나서 반갑습니다. 안녕하세요 NextIT 입니다. 만나서 반갑습니다. 안녕하세요
						NextIT 입니다. 만나서 반갑습니다. 안녕하세요 NextIT 입니다. 만나서 반갑습니다. 안녕하세요 NextIT
						입니다. 만나서 반갑습니다. 안녕하세요 NextIT 입니다. 만나서 반갑습니다.</p>
				</div>
			</div>
		</div>
		<!--4차 작업 main_text1 e -->
